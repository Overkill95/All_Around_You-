...
ActiveRecord::Schema.define(version: 20181106102323) do
  ...
  create_table "recensionis", force: :cascade do |t|
    ...
    t.index ["user_id", "servizi_id"], name: "index_recensionis_on_user_id_and_servizi_id", unique: true
  ...
  create_table "servizis", force: :cascade do |t|
    ...
    t.float "latitude"
    t.float "longitude"
    t.integer "numvoti", default: 0
    t.integer "mediavoti", default: 0
  ...
  create_table "voti_ds", force: :cascade do |t|
    t.boolean "voto"
    t.integer "user_id"
    t.integer "domande_id"
    t.datetime "created_at", null: false
  ...
  create_table "votiservizis", force: :cascade do |t|
    t.boolean "voto"
    t.integer "user_id"
    t.integer "servizi_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["servizi_id"], name: "index_votiservizis_on_servizi_id"
    t.index ["user_id"], name: "index_votiservizis_on_user_id"
  end
